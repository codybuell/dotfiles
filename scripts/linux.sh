...
if [ -f /etc/redhat-release ]; then
  FAMILY='el'
  REMOVE=(tmux vim zsh)
  INSTALL=(w3m ack ctags ruby python2-pip python34-pip freerdp mutt npm imapfilter pass gnupg1 gnupg2 gnupg2-smime pcsc-tools lastpass-cli isync ykclient ykpers opensc)
