 ...
 *
 * Taken from @wincent https://github.com/wincent/wincent, written as an
 * ECMAScript module.
 *
...
/**
  * Launcher, o + <from> simultaneously to open <args>.
 **/
...
/**
  * Abstraction for two fromTo mappings.
 **/
function swap(a, b) {
...
const DEFAULT_PROFILE = applyExemptions({
  ...
  devices: [REALFORCE, APPLE_INTERNAL_US, APPLE_INTERNAL_M1_US, APPLE_INTERNAL_ES, APPLE_MAGIC_W_NUM_US],
  name: 'Default',
  selected: true,
});
