...
" Copy Matches                                                               "
"                                                                            "
" Copy only the text that matches search hits.  Will work after any search,  "
" including searches which match text on more than one line. CopyMatches     "
" will grab just the match, CopyLines will grab the whole line containing    "
" the match.                                                                 "
"                                                                            "
" Good for large log parsing where you want to pull out lines that match     "
" a particular regex.                                                        "
"                                                                            "
...
"   Basic usage:                                                             "
"                                                                            "
"   1. perform a search, eg :s/foo//n                                        "
"        see :help :s                                                        "
"            :help :s_flags                                                  "
"            :help :s_flags                                                  "
"   2. call :CopyMatches[!] [xX-] [pattern]                                  "
"      or                                                                    "
"      call :CopyLines[!] [xX-] [pattern]                                    "
"                                                                            "
"      null       (no args) copy matches to clipboard                        "
"      !          (with any of above options) insert line numbers            "
"      x          copy matches to register x, supports any register          "
"      X          append matches to register x, supports any register        "
"      -          display matches in a scratch buffer, append to if exists   "
"      pattern    (after any of above options) use 'pat' as search pattern   "
"                                                                            "
"   - you can also specify a range to limit which matches get copied         "
"                                                                            "
" Examples:                                                                  "
"                                                                            "
"     :1,10CopyMatches        grab matches from lines 1,10                   "
"     :.CopyMatches           grab matches from the current line             "
"     :CopyMatches            grab all matches across the current buffer     "
"                                                                            "
"     :let @a = ''            copy matches from all buffers to register A    "
"     :bufdo CopyMatches A    ''                                             "
"                                                                            "
"                                                                            "
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
