...
local has_todocomments, todocomments = pcall(require, 'todo-comments')
if not has_todocomments then
  return
end
...
local config = {
  ...
  highlight = {
    ...
    keyword = "fg",       -- "fg", "bg", "wide" or empty. (wide = bg + surrounding characters)
