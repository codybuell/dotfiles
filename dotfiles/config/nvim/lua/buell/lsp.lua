...
lsp.init = function()
  ...
  vim.lsp.config('yamlls', {
    settings = {
      yaml = {
        schemas = {
          ["http://{{ WorkSchemaHost }}/v1/jumpstart-framework.json"] = 'frameworks/*.yml',
          ["http://{{ WorkSchemaHost }}/v1/jumpstart-cc-aws.json"] = 'compliance-checks/cloud-custodian/aws/*.yml',
          ["http://{{ WorkSchemaHost }}/v1/jumpstart-cc-azure.json"] = 'compliance-checks/cloud-custodian/azure/*.yml',
          ["http://{{ WorkSchemaHost }}/v1/jumpstart-cc-cost-savings.json"] = 'cost-savings/*/cloud-custodian/*/*.yml',
