...
vim.opt.foldexpr       = 'v:lua.buell.foldexpr(v:lnum)'        -- func for when method is expr (ie treesitter)
vim.opt.foldminlines   = 0                                     -- smallest section to try and fold (fold all)
...
vim.opt.listchars      = {
  ...
  -- tab               = '󰌒 ',                                 -- NF-MD-KEYBOARD_TAB (U+DB80U+DF12 NERD FONT F0312)
...
vim.opt.pumblend       = 0                                     -- pseudo-transparency for popup-menu (0 for off, else 10 is good)
